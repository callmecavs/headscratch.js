...
const attribution =
`/*!
 * Headscratch.js ${ pkg.version } - ${ pkg.description }
...
gulp.task('js', () => {
  return rollup
    ...
    .then(bundle => {
      ...
      // write sourcemap
      fs.writeFileSync('dist/maps/headscratch.js.map', umd.map.toString())
    })
    .catch(onError)
})
